...
import org.google.security.core.authentication.AbstractChannelSecurityConfig;
...
import org.google.security.core.validate.ValidateCodeSecurityConfig;
...
public class BrowserSecurityConfig extends AbstractChannelSecurityConfig {
    ...
    @Autowired
    private SpringSocialConfigurer googleSpringSocialConfigurer;
...
//        tokenRepository.setCreateTableOnStartup(true);
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.apply(validateCodeSecurityConfig)
                ...
                .and()
                .apply(googleSpringSocialConfigurer)
                .and()
                .rememberMe()
